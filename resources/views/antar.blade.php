...
<main class="container mx-auto px-6 py-10">
    <div class="bg-blue-500 text-white p-6 rounded-lg shadow-md">
      <h2 class="text-2xl font-bold mb-2"> Antar Jemput Bandara | Cek & Pesan Harga Promo Travelin</h2>
    ...
    <div class="mt-6 bg-white p-6 rounded-lg shadow-md">
      <div class="flex items-center justify-between border-b pb-3">
        <div class="flex space-x-4">
            <p class="px-4 py-2 text-blue-600 font-semibold border-b-2 border-blue-600">Antar Jemput</p>
        </div>
      ...
      <form class="mt-6 space-y-4">
        <div class="grid grid-cols-2 gap-4">
          <div>
            <label for="from" class="block text-gray-700 font-semibold">Dari</label>
            <input type="text" id="from" placeholder="Jakarta (CGK)" class="w-full mt-2 p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:outline-none">
          </div>
          <div>
            <label for="to" class="block text-gray-700 font-semibold">Ke</label>
            <input type="text" id="to" placeholder="Summarecon Mall Serpong" class="w-full mt-2 p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:outline-none">
          </div>
        </div>

        <div class="grid grid-cols-2 gap-4">
          <div>
            <label for="depart-date" class="block text-gray-700 font-semibold">Tanggal pergi</label>
            <input type="date" id="depart-date" value="2024-12-08" class="w-full mt-2 p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:outline-none">
          </div>
        </div>

        <div class="grid grid-cols-2 gap-4">
          <div>
            <label for="passengers" class="block text-gray-700 font-semibold">Jumlah Penumpang</label>
            <input type="text" id="passengers" value="1 Dewasa, 0 Anak, 0 Bayi" class="w-full mt-2 p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:outline-none">
          </div>
          <div>
            <label for="class" class="block text-gray-700 font-semibold">Waktu</label>
            <input type="time" id="class" class="w-full mt-2 p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:outline-none">
            </input>
          </div>
        </div>
        ...
        <button class="w-full bg-orange-500 text-white py-2 rounded-lg font-semibold hover:bg-orange-600">Cari Tiket</button>
      </form>
    </div>
  </main>
</body>
