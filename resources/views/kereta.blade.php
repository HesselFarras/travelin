...
<main class="container mx-auto px-6 py-10">
    <div class="bg-blue-500 text-white p-6 rounded-lg shadow-md">
      <h2 class="text-2xl font-bold mb-2">Tiket Kereta Murah | Cek & Pesan Harga Promo Travelin</h2>
      ...
      <form class="mt-6 space-y-4">
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" id="from" placeholder="Jakarta (JKTA)" class="w-full mt-2 p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:outline-none">
          </div>
          <div>
            <label for="to" class="block text-gray-700 font-semibold">Ke</label>
            <input type="text" id="to" placeholder="Bali / Denpasar (DPS)" class="w-full mt-2 p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:outline-none">
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select id="class" class="w-full mt-2 p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:outline-none">
