...
<main class="container mx-auto px-6 py-10">
    <div class="bg-blue-500 text-white p-6 rounded-lg shadow-md">
      <h2 class="text-2xl font-bold mb-2">Rental Kendaraan | Cek & Pesan Harga Promo Travelin</h2>
    ...
    <div class="mt-6 bg-white p-6 rounded-lg shadow-md">
      <div class="flex items-center justify-between border-b pb-3">
        <div class="flex space-x-4">
          <button class="px-4 py-2 text-blue-600 font-semibold border-b-2 border-blue-600">Rental Kendaraan</button>
        </div>
      ...
      <form class="mt-6 space-y-4">
        <div class="grid grid-cols-2 gap-4">
          <div>
            <label for="from" class="block text-gray-700 font-semibold">Lokasi Rental</label>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            <label for="depart-date" class="block text-gray-700 font-semibold">Tanggal mulai</label>
          ...
          <div>
            <label for="return-checkbox" class="text-gray-700 font-semibold">Tanggal selesai</label>
            <input type="date" id="depart-date" value="2024-12-08" class="w-full mt-2 p-2 border rounded focus:ring-2 focus:ring-blue-500 focus:outline-none">
